...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: "Aerial Allies | Drone Service Across Southeast Nebraska" },
			{
				name: "description",
				content: "Aerial Allies LLC — agricultural, residential, and pet-rescue drone service across Southeast Nebraska. Based near Hallam. Neighbors helping neighbors from the air."
			},
			{
				name: "theme-color",
				content: "#5A843A"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Montserrat:wght@500;600;700;800&family=Source+Sans+3:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600&display=swap"
			},
			{
				rel: "stylesheet",
				href: styles_default
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			className: "min-h-dvh bg-mist text-ink",
			children: [
